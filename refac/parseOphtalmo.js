...
20. 2
21. 4`
let answerArr = answers.split(/\n\d+\. /g).map(v => v.split(',').map(j => +j))
let answerObj = {}
let questions = `ЧТО ХАРАКТЕРИЗУЕТ ПОНЯТИЕ: ОСТРОТА ЗРЕНИЯ ЧЕЛОВЕЧЕСКОГО ГЛАЗА?
...
2. ЧЕМУ В НОРМЕ РАВЕН МИНИМАЛЬНЫЙ УГОЛ ЗРЕНИЯ?
1) 1 секунде – 5 секундам
2) 1 минуте
3) 5 минутам
4) 1 градусу
5) градусам
3. В КАКИХ ЕДИНИЦАХ ИЗМЕРЯЕТСЯ ОСТРОТА ЗРЕНИЯ?
1) относительными
2) сантиметрами
3) миллиметрами
4) диоптриями
...
6) метрами
6
4. КАК МЕНЯЕТСЯ УГОЛ ЗРЕНИЯ ЕСЛИ ОСТРОТА ЗРЕНИЯ ПОВЫШАЕТСЯ?
1) уменьшается
2) увеличивается
3) нет взаимозависимости
5. КАКОВА ВЗАИМОЗАВИСИМОСТЬ МЕЖДУ УГЛОМ ЗРЕНИЯ И ОСТРОТОЙ ЗРЕНИЯ?
1) прямая
2) зависимости между ними нет
3) обратная
6. РАВНОМЕРНА ЛИ ОСТРОТА ЗРЕНИЯ НА РАЗЛИЧНЫХ УЧАСТКАХ СЕТЧАТКИ?
1) нет
2) да
7. КАКАЯ ОБЛАСТЬ СЕТЧАТКИ ОБЕСПЕЧИВАЕТ НАИБОЛЕЕ ВЫСОКУЮ ОСТРОТУ ЗРЕНИЯ?
...
1) да
2) нет
13. ИССЛЕДУЕМЫЙ ПАЦИЕНТ С РАССТОЯНИЯ 5 МЕТРОВ ЧИТАЕТ ТОЛЬКО ПЕРВУЮ СТРОКУ ТАБЛИЦЫ СИВЦЕВА. КАКАЯ У НЕГО ОСТРОТА ЗРЕНИЯ?
1) 0,1
2) 0,2
3) 0,5
4) 1,0
...
3) 4 м
4) 5 м
15. КАКУЮ ОСТРОТУ ЗРЕНИЯ ИМЕЕТ ИССЛЕДУЕМЫЙ ПАЦИЕНТ, ЕСЛИ ОН СЧИТАЕТ ПАЛЬЦЫ С РАССТОЯНИЯ 2,5 м?
1) 0,025
2) 0,05
3) 0,25
4) 0,5
8
16. КАКУЮ ОСТРОТУ ЗРЕНИЯ ИМЕЕТ ИССЛЕДУЕМЫЙ ПАЦИЕНТ, ЕСЛИ ЧИТАЕТ ПЕРВУЮ СТРОЧКУ ТАБЛИЦЫ С 3 м?
1) 0,03
2) 0,06
3) 0,3
17. КАКОВА ОСТРОТА ЗРЕНИЯ ИССЛЕДУЕМОГО ПАЦИЕНТА, ЕСЛИ ОН СЧИТАЕТ ПАЛЬЦЫ С РАССТОЯНИЯ 50 см?
1) 0,005
2) 0,01
3) 0,05
18. С КАКОГО РАССТОЯНИЯ В РОССИИ ПРОВОДИТСЯ ИССЛЕДОВАНИЕ ОСТРОТЫ ЗРЕНИЯ ПО ТАБЛИЦАМ?
1) 2 м
2) 3 м
3) 4 м
4) 5 м
19. КАК ДОЛГО ПРИ ИССЛЕДОВАНИИ ОСТРОТЫ ЗРЕНИЯ НУЖНО ДЕМОНСТРИРОВАТЬ КАЖДЫЙ ЗНАК ТАБЛИЦЫ?
1) 1
2) 3
3) 10
4) 20
20. СКОЛЬКО ЦВЕТОВ РАЗЛИЧАЮТ В СПЕКТРЕ БЕЛОГО ЦВЕТА?
1) 5
2) 7
3) 9
4) 12
...
6) синий
7) фиолетовый
24. КАКИЕ ТРИ ЦВЕТА ЯВЛЯЮТСЯ КОРОТКОВОЛНОВЫМИ?
1) красный
2) оранжевый
3) желтый
4) зеленый
...
6) синего
7) фиолетового
29. КАКИЕ РЕЦЕПТОРЫ СЕТЧАТКИ ВОСПРИНИМАЮТ ЦВЕТА?
1) колбочки
2) биполярные клетки
3) палочки
4) клетки пигментного эпителия
5) ганглиозные клетки эпителия
30. РАССТРОЙСТВАМИ ЦВЕТООЩУЩЕНИЯ ЯВЛЯЮТСЯ?
...
5) полное выпадение восприятия зеленого цвета
6) полное выпадение восприятия синего цвета
34. КАКИЕ РАССТРОЙСТВА ЦВЕТООЩУЩЕНИЯ ЯВЛЯЮТСЯ ВРОЖДЕННЫМИ?
...
35. КАКИЕ РАССТРОЙСТВА ЦВЕТООЩУЩЕНИЯ ЯВЛЯЮТСЯ ПРИОБРЕТЕННЫМИ?
1) аномальная трихромазия, цветоаномалии, дихромазии
2) цветоаномалии, дихромазия, эритропсия
3) дихромазия, аномальная трихромазия, цианопсия
4) эритропсия, ксантопсия, хлоропсия, цианопсия
40
36. У БОЛЬНОГО ПОСЛЕ ЭКСТРАКЦИИ КАТАРАКТЫ ВСЕ ПРЕДМЕТЫ В ОПЕРИРОВАННОМ ГЛАЗУ КАЖУТСЯ ОКРАШЕННЫМИ В ГОЛУБОЙ ЦВЕТ. ВАШ ДИАГНОЗ?
1) протанопия
2) эритропсия
3) дейтеранопия
4) хлоропсия
...
5) тританопия
6) цианопсия
38. ВСЛЕДСТВИЕ ЧЕГО ПОНЯТИЕ ПОЛЯ ЗРЕНИЯ ИМЕЕТ БОЛЬШОЕ ЗНАЧЕНИЕ?
...
40. КАК НАЗЫВАЕТСЯ МЕТОД ИССЛЕДОВАНИЯ ПОЛЯ ЗРЕНИЯ?
1) визометрия
2) биомикроскопия
3) аномалоскопия
4) офтальмоскопия
...
5) периметрия
6) биометрия
41. УКАЖИТЕ ДВА ФИЗИОЛОГИЧЕСКИХ ДЕФЕКТА ПОЛЯ ЗРЕНИЯ.
1) слепое пятно
2) скотомы на периферии
3) отрицательные скотомы поля зрения
4) ангиоскотомы
5) концентрическое сужение поля зрения до 20 градусов
42. КАК НАЗЫВАЕТСЯ СКОТОМА, КОТОРУЮ ОЩУЩАЕТ САМ БОЛЬНОЙ?
1) отрицательной
2) абсолютной
3) положительной
4) относительной
43. КАКИЕ ПРИБОРЫ ПРИМЕНЯЮТСЯ ДЛЯ ИССЛЕДОВАНИЯ ПОЛЯ ЗРЕНИЯ?
...
3) в минутах
4) в градусах
45. К КАКОМУ ВИДУ СКОТОМ ОТНОСИТСЯ СЛЕПОЕ ПЯТНО?
...
5) квадрантные
6) все перечисленные
48. КАКИЕ НЕВРОЛОГИЧЕСКИЕ ЗОНЫ ПОРАЖАЮТСЯ ПРИ БИТЕМПОРАЛЬНОЙ ГЕМИАНОПСИИ?
1) зрительный нерв
...
49. КАК НАЗЫВАЮТСЯ ИЗМЕНЕНИЯ ПОЛЯ ЗРЕНИЯ ПРИ ПОВРЕЖДЕНИИ ЦЕНТРАЛЬНЫХ ОТДЕЛОВ ХИАЗМЫ?
...
3) 3
4) 4
52. КАК РАССТРОЙСТВО СУМЕРЕЧНОГО ЗРЕНИЯ НАЗЫВАЕТСЯ?
1) гемералопией
2) тританопией
3) протанопией
4) скотомой
...
1) нет
2) да
55. ВСЕ ЛИ ВИДЫ ПЕРЕЧИСЛЕННЫХ КЛЕТОК ЯВЛЯЮТСЯ ФОТОРЕЦЕПТОРАМИ?
1) колбочки, палочки
...
56. КАКИЕ ВИДЫ КЛЕТОК ОБЕСПЕЧИВАЮТ ДНЕВНОЕ ЗРЕНИЕ?
1) колбочки
2) палочки
3) ганглиозные клетки сетчатки
4) клетки пигментного эпителия
5) биполярные клетки сетчатки
44
57. КАКИЕ ВИДЫ КЛЕТОК ОБЕСПЕЧИВАЮТ СУМЕРЕЧНОЕ ЗРЕНИЕ?
1) колбочки
2) палочки
3) ганглиозные клетки сетчатки
4) клетки пигментного эпителия
...
59. ЧТО ТАКОЕ МЕЗОПИЧЕСКОЕ ЗРЕНИЕ?
1) сумеречное зрение
2) дневное зрение
3) ночное зрение
4) периферическое зрение
5) центральное зрение
60. СКОТОПИЧЕСКОЕ ЗРЕНИЕ – ЧТО ЭТО?
1) ночное зрение
2) сумеречное зрение
3) дневное зрение
4) куриная слепота
...
5) полное выпадение восприятия зеленого цвета
6) полное выпадение восприятия синего цвета
64. ИССЛЕДУЕМЫЙ ПАЦИЕНТ ОДНИМ ГЛАЗОМ ПРАВИЛЬНО НАЗЫВАЕТ ВСЕ ЗНАКИ В ТАБЛИЦАХ РАБКИНА, А ДРУГИМ ГЛАЗОМ ИХ ПУТАЕТ. КАКОЕ У НЕГО РАССТРОЙСТВО ЦВЕТООЩУЩЕНИЯ?
1) врожденное
2) приобретенное
3) может и то и другое
4) по этим данным установить невозможно
65. У ИССЛЕДУЕМОГО ПАЦИЕНТА ОСТРОТА ЗРЕНИЯ ОБОИХ ГЛАЗ С КОРРЕКЦИЕЙ 0,7, НО ОН НЕПРАВИЛЬНО ЧИТАЕТ ЗНАКИ В ТАБЛИЦАХ РАБКИНА. КАКОЙ ТИП РАССТРОЙСТВА ЦВЕТООЩУЩЕНИЯ У НЕГО?
1) врожденный
2) приобретенный
3) может быть и то, и другое
4) по приведенным данным установить нельзя
66. ДЛЯ КАКОЙ ЦЕЛИ СЛУЖИТ ПРИБОР АНОМАЛОСКОП?
...
46
67. ИССЛЕДУЕМЫЙ ПАЦИЕНТ ВИДИТ ТОЛЬКО СВЕТ, НО ЛОКАЛИЗУЕТ ЕГО ТОЛЬКО С ТРЕХ СТОРОН, ОСТРОТА ЗРЕНИЯ РАВНА
1) l/∞ pr. Incerta
2) l/∞ pr. Certa
...
4) носовой полостью
5) основной пазухой
4. С ЧЕМ ГРАНИЧИТ ВНУТРЕННЯЯ СТЕНКА ОРБИТЫ?
1) крылонебной ямкой
2) лобной пазухой
3) гайморовой пазухой
4) решетчатой пазухой
5) основной пазухой
5. ПРИ КАКИХ СОСТОЯНИЯХ НЕОБХОДИ МО УЧИТЫВАТЬ СОСЕДСТВО ОРБИТЫ С ПРИДАТОЧНЫМИ ПАЗУХАМИ НОСА?
...
1) не погружение слезных точек в слезное озеро
...
2. ЧЕРЕЗ КАКОЙ ПРОМЕЖУТОК ВРЕМЕНИ ПОСЛЕ ЗАКАПЫВАНИЯ SOL. COLLARGOLI 3% НАЧИНАЕТ ОБЕСЦВЕЧИ ВАТЬСЯ ГЛАЗНОЕ ЯБЛОКО, ЕСЛИ КАНАЛЬЦЕВАЯ ПРОБА СЧИТАЕТСЯ ПОЛОЖИТЕЛЬНОЙ?
1) 2 минуты
13
2) 10 минут
3) 3-4 минуты
4) более 10 минут
5) 5 минут
3. ЧЕРЕЗ КАКОЙ ПРОМЕЖУТОК ВРЕМЕНИ SOL. COLLARGOLI 3% ПОПАДАЕТ В НОС С ВЛУЧАЕ, КОГДА НОСОВАЯ ПРОБА СЧИТАЕТСЯ ПОЛОЖИТЕЛЬНОЙ?
1) 1-2 минуты
2) 10-15 минут
3) 3-5 минут
4) 15-20 минут
5) 5-10 минут
4. КАКОЕ КРАСЯЩЕЕ ВЕЩЕСТВО ПРИМЕНЯЮТ ДЛЯ ПРОВЕДЕНИЯ СЛЕЗНО-НОСОВОЙ ПРОБЫ?
1) фурацилин 1:5000
2) йод 5%
3) Sol.Collargoli 3%
4) 1% спиртовой раствор бриллиантовой зелени
5. КАК ВЫТЕКАЕТ ПРОМЫВНАЯ ЖИДКОСТЬ ПРИ НОРМАЛЬНОЙ ПРОХОДИМОСТИ СЛЕЗООТВОДЯЩИХ ПУТЕЙ ВО ВРЕМЯ ИХ ПРОМЫВАНИЯ?
1) струйкой из носа
2) через другую слезную точку
3) каплями из носа
4) через ту же слезную точку
6. КАКОЙ МЕТОД ИССЛЕДОВАНИЯ ДАЕТ НАИБОЛЕЕ ПОЛНУЮ ИНФОРМАЦИЮ ОБ УРОВНЕ ОБЛИТЕРИЗАЦИИ СЛЕ ЗООТВОДЯЩИХ ПУТЕЙ?
1) канальцевая проба
...
6) проба Ширмера
7. ГДЕ ЛОКАЛИЗУЕТСЯ ПАТОЛОГИЧЕСКИЙ ПРОЦЕСС ПРИ ОСТРОМ ДАКРИОАДЕНИТЕ?
...
8. ОСЛОЖНЕНИЕМ КАКИХ ОБЩИХ ИНФЕКЦИЙ ЯВЛЯЕТСЯ ДАКРИОАДЕНИТ?
1) гриппа
2) брюшного тифа
3) ангины
4) эпидемического паротита
5) любого из перечисленных заболеваний
9. ЧТО ЯВЛЯЕТСЯ ПРИЧИНОЙ ХРОНИЧЕСКОГО ДАКРИОЦИСТИТА?
...
11. ДАЙТЕ ОПРЕДЕЛЕНИЕ НАРУЖНОГО ЯЧМЕНЯ?
...
12. НАЗОВИТЕ МИКРОБНЫЕ АГЕНТЫ НАРУЖНОГО ЯЧМЕНЯ.
1) диплококк
2) стафилококк
3) пневмококк
4) стрептококк
13. КАКИЕ ПРИЧИНЫ ИНДУЦИРУЮТ ВОЗНИКНОВЕНИЕ ЯЧМЕНЯ?
1) парез тройничного нерва
2) нервный стресс
48
3) авитаминоз, ослабление организма после перенесен ных инфекций
4) длительная работа, связанная с напряжением аккомодации
14. НАЗОВИТЕ СИМПТОМОКОМПЛЕКС НАЧИНАЮЩЕГОСЯ ПРОЦЕССА ПРИ ЯЧМЕНЕ:
...
15. КАКИЕ МАНИПУЛЯЦИИ ПРИ ЛЕЧЕНИИ ЯЧМЕНЯ МОГУТ ПРИВЕСТИ К ТАКИМ ОСЛОЖНЕНИЯМ, КАК ФЛЕГМОНА ОРБИТЫ, ТРОМБОФЛЕБИТ ОР БИТАЛЬНЫХ ВЕН?
1) примочки из чая
2) сухое тепло
3) аутогемотерапия
4) попытки выдавливания гноя
16. ПРИ ОПЕРАТИВНОМ УДАЛЕНИИ ХАЛЯЗИОНА, УДАЛЕННАЯ ТКАНЬ ОТПРАВЛЯЕТСЯ НА ГИСТОЛОГИЮ, ПОТОМУ ЧТО:
1) халязион – это злокачественное образование
2) дает метастазы в трубчатые кости
3) вместо халязиона может быть аденокарцинома мейбомиевой железы
4) для определения вирусных включений в клетках
17. ЛАГОФТАЛЬМ ХАРАКТЕРИЗУЕТСЯ:
...
18. ПОРАЖЕНИЕМ ЧЕГО МОЖЕТ БЫТЬ ОБУСЛОВЛЕН ПТОЗ?
1) n. Facialis
2) n. abducens
3) n. trigeminus
4) n. oculomotorius
49
19. КАКОЙ СИМПТОМОКОМПЛЕКС ХАРАКТЕРЕН ДЛЯ ПТОЗА?
1) невозможность закрыть глазную щель
...
20. ВЫБЕРИТЕ ПРАВИЛЬНЫЙ СПОСОБ ЛЕЧЕНИЕ ПТОЗА?
1) хирургическое
2) инстилляции Sol. Atropini sutfaiis 1%
...
23. ЧТО ЯВЛЯЕТСЯ ЗАЛОГОМ УСПЕШНОГО ЛЕЧЕНИЯ БЛЕФАРИТА?
...
50
24. ЧТО ИЗ ПЕРЕЧИСЛЕННОГО ЯВЛЯЕТСЯ ЗЛОКАЧЕСТВЕННЫМ НОВООБРАЗОВАНИЕМ ВЕК?
1) дермоидная киста
...
25. ЧТО ИЗ ПЕРЕЧИСЛЕННОГО ЯВЛЯЕТСЯ ДОБРОКАЧЕСТВЕННЫМ НОВООБРАЗОВАНИЕМ ВЕК?
1) дермоидная киста
2) аденокарцинома мейбомиевой железы
3) аденома мейбомиевой железы
4) все перечисленные образования
5) ни одно из перечисленных образований
1. КАК НАЗЫВАЕТСЯ НАРУЖНАЯ (ФИБРОЗНАЯ) ОБОЛОЧКА ГЛАЗА?
1) белком
2) конъюнктивой
3) склерой
4) эпителием
2. КАКИЕ ФУНКЦИИ СКЛЕРЫ ЯВЛЯЮТСЯ ОСНОВНЫМИ?
1) опорная
...
3. КАКОВО ГИСТОЛОГИЧЕСКОЕ СТРОЕНИЕ СКЛЕРЫ?
...
4. В КАКОЙ ОБЛАСТИ ГЛАЗНОГО ЯБЛОКА ОПРЕДЕЛЯЕТСЯ НАИБОЛЬШАЯ ТОЛЩИНА СКЛЕРЫ?
1) в области экватора глазного яблока
2) в области заднего полюса глаза
3) равномерна на всем протяжении
5. ПРИ КАКИХ НАРУШЕНИЯХ ЧАЩЕ ВОЗНИКАЮТ СКЛЕРИТЫ И ЭПИСКЛЕРИТЫ?
...
6. В ЧЕМ ОТЛИЧИЕ СКЛЕРИТОВ ОТ ЭПИСКЛЕРИТОВ?
1) В способе проникновения инфекционного агента
2) в характере воспалительного процесса
3) в глубине поражения
16
7. КАКИЕ СТРУКТУРЫ ПРЕИМУЩЕСТВЕН НО ВОВЛЕКАЮТСЯ В ВОСПАЛИТЕЛЬНЫЙ ПРОЦЕСС ПРИ ЭПИСКПЕРИТЕ?
1) поверхностные слои склеры – вся толща склеры
2) глу6окие (внутренние) слои склеры
8. КАКИМИ ПРИЗНАКАМИ ОБЪЕКТИВНО ХАРАКТЕРИЗУЕТСЯ КЛИНИКА ЭПИСКЛЕРИТА?
...
9. КАК ИЗМЕНЯЕТСЯ ОСТРОТА ЗРЕНИЯ ПРИ ЭПИСКЛЕРИТАХ?
1) практически не страдает
2) медленно ухудшается
3) резко и значительно снижается
10. КАКОВ ПРОГНОЗ В ОТНОШЕНИИ ЗРИТЕЛЬНЫХ ФУНКЦИЙ ПРИ ЭПИСКЛЕРИТАХ?
1) благоприятный
2) неблагоприятный
3) сомнительный
11. ЧТО ПРОИСХОДИТ С ИНФИЛЬТРАТИВНЫМИ ОЧАГАМИ И В ИСХОДЕ СКЛЕРИТА?
...
12. КАКИЕ ЛЕКАРСТВЕННЫЕ СРЕДСТВА ВКЛЮЧАЕТ КОМПЛЕКСНАЯ ТЕРАПИЯ СКЛЕРИТОВ?
1) антибактериальные средства, сосудорасширяющие, иммуностимуляторы, тканевые биостимуляторы
17
2) антибиотики, иммуномодуляторы, стимуляторы пролиферации
3) кортикостероиды, иммунодепрессанты, антигистаминные средства
13. КАКИЕ ОТДЕЛЫ КОНЪЮНКТИВЫ ВЫДЕЛЯЮТ АНАТОМИЧЕСКИ?
...
14. НАЗОВИТЕ ГИСТОЛОГИЧЕСКИЕ ОСОБЕННОСТИ КОНЪЮНКТИВЫ ВЕК?
...
7) все правильно
16. ЧТО НЕ ХАРАКТЕРНО ДЛЯ КОНЪЮНКТИВЫ ГЛАЗНОГО ЯБЛОКА?
...
4) все перечисленные
5) увлажняющую
18. ЧТО ЯВЛЯЕТСЯ ОСНОВОЙ БАРЬЕРНОЙ ФУНКЦИИ КОНЪЮНКТИВЫ?
...
19. ЧЕМ ОБЕСПЕЧИВАЕТСЯ ТРОФИЧЕСКАЯ ФУНКЦИЯ КОНЪЮНКТИВЫ?
1) слезой и секретом конъюнктивальных желез
2) аденоидной тканью подслизистого слоя
20. ЧТО ХАРАКТЕРНО ДЛЯ АДЕНОВИРУСНОГО КОНЪЮНКТИВИТА?
...
21. В КАКИХ ФОРМАХ ПРОЯВЛЯЕТСЯ АДЕНОВИРУСНЫЙ КОНЪЮНКТИВИТ?
1) катаральной
2) пленчатой
3) фолликулярной
...
4) все перечисленное
19
23. КАКОЕ ПРОЯВЛЕНИЕ НЕ ХАРАКТЕРНО ДЛЯ КАТАРАЛЬНОЙ ФОРМЫ АДЕНО-ВИРУСНОГО КОНЪЮНКТИВИТА?
...
24. КАКИЕ ПРОЯВЛЕНИЯ НЕ ХАРАКТЕРНЫ ДЛЯ ФОЛЛИКУЛЯРНОЙ ФОРМЫ АДЕНОВИРУСНОГО КОНЪЮНКТИВИТА?
...
25. ДЛЯ ПЛЕНЧАТОЙ ФОРМЫ АДЕНОВИРУСНОГО КОНЪЮНКТИВИТА НЕ ХАРАКТЕРНО?
...
3) 4
4) 5
27. КАКИЕ ПОСЛЕДСТВИЯ ТРАХОМЫ ВЫ ЗНАЕТЕ?
1) трихиаз
51
...
29. ЧТО ТАКОЕ ЭНТРОПИОН?
1) неправильный рост ресниц
2) заворот век, при котором ресницы растут по направлению к глазу
3) сращение конъюнктивы век и глазного яблока
4) высыхание конъюнктивы и роговой оболочки
30. ЧТО ТАКОЕ СИМБЛЕФАРОН?
1) неправильный рост ресниц
2) заворот век, при котором ресницы растут по направлению к глазу
3) сращение конъюнктивы век и глазного яблока
4) высыхание конъюнктивы и роговой оболочки
31. ЧТО ТАКОЕ ПАРЕНХИМАТОЗНЫЙ КСЕРОЗ?
1) неправильный рост ресниц
2) заворот век, при котором ресницы растут по направлению к глазу
3) сращение конъюнктивы век и глазного яблока
4) высыхание конъюнктивы и роговой оболочки
32. КОНЪЮНКТИВИТАМИ АЛЛЕРГИЧЕСКОГО ГЕНЕЗА ЯВЛЯЮТСЯ ВСЕ ПЕРЕЧИСЛЕННЫЕ, КРОМЕ?
1) лекарственного
2) фликтенулезного
3) поллинозного
4) аденовирусного
5) весеннего
52
33. НАЗОВИТЕ ЭТИОЛОГИЧЕСКИЕ ФАКТОРЫ ПОЛЛИНОЗНОГО КОНЪЮНКТИВИТА?
1) пыльцой растений
2) местным применением ряда лекарственных препаратов
3) аутоиммунными факторами
34. КАКИЕ СИМПТОМЫ НЕХАРАКТЕРНЫ ДЛЯ ЛЕКАРСТВЕННОГО КОНЪЮНКТИВИТА?
...
37. КАК ЛЕЧИТЬ ПРОГРЕССИРУЮЩИЙ ПТЕРИГИУМ?
1) хирургическое удаление
2) противовоспалительная терапия
3) лечения не требуется
53
38. КАКИЕ ЛЕКАРСТВЕННЫЕ СРЕДСТВА НЕ ПРИМЕНЯЕТСЯ ДЛЯ ЛЕЧЕНИЯ АЛЛЕРГИЧЕСКОГО КОНЪЮНКТИВИТА?
1) Ung. Hydrocortisony ophthalmici 0,5-1%
2) Sol. Dexamethasoni 0,1 %
3) 1% раствор преднизолона (глазные капли)
4) антигистаминные препараты внутрь
5) Sol. Atropini sulfatis 1%
39. ИЗ ПРИВЕДЕННЫХ НИЖЕ ПРЕПАРАТОВ ВЫБЕРИТЕ ТЕ, ЧТО НЕ ИСПОЛЬЗУЮТСЯ ДЛЯ ЛЕЧЕНИЯ ПОЛЛИНОЗНОГО КОНЬЮКТИВИТА.
1) эмульсия гидрокортизона 0.5-1%
...
4) 5%
5) 10%
41. ИЗ ПРИВЕДЕННЫХ НИЖЕ ПРЕПАРАТОВ ВЫБЕРИТЕ НЕ ИСПОЛЬЗУЕМЫЕ ДЛЯ ЛЕЧЕНИЯ ВИРУСНЫХ КОНЬЮКТИВИТОВ.
1) флореналовая мазь
2) оксолиновая мазь
...
42. ДЛЯ ЛЕЧЕНИЯ АДЕНОВИРУСНОГО КОНЪЮНКТИВИТА ПРИМЕНЯЮТСЯ ВСЕ ПРЕПАРАТЫ, КРОМЕ?
1) Ung. Bonaphtoni 0,05%
2) Sol. Irrterferoni leicocytaris
3) Ung. Florenali 0,25-0,5%
54
4) Sol. Poludani
5) Ung. Tebropheni 0,25-0,5%
6) Ung. Zoviraxi 3%
7) Sol. Atropini sulfatis 1%
8) пирогенал в глазных каплях
43. РЕБЕНОК 11 ЛЕТ ОБРАТИЛСЯ С ЖАЛОБАМИ НА БОЛЬ В ГОРЛЕ, ПОВЫШЕНИЕ ТЕМПЕРАТУРЫ ТЕЛА, РЕЗЬ В ОБОИХ ГЛАЗАХ И СКЛЕИ ВАНИЕ ВЕК УТРОМ. БОЛЕН 1ДЕНЬ. ОБЪЕКТИВНО: ТЕМПЕРАТУРА ТЕЛА 37,8°С., СЛИЗИСТАЯ ЗЕВА И ГЛОТКИ ГИПЕРЕМИРОВАНА, КОНЪЮНКТИВА ВЕК ГИПЕРЕМИРОВАНА, РАЗРЫХЛЕНА. ФОЛЛИКУЛЫ В КОНЪЮНКТИВЕ ВЕК СИЛЬНО УВЕЛИЧЕНЫ КАК В КОЛИЧЕСТВЕ, ТАК И ПО ВЕЛИЧИНЕ. ВАШ ДИАГНОЗ?
...
45. У БОЛЬНОГО, ЖАЛУЮЩЕГОСЯ НА РЕЗЬ, ОЩУЩЕНИЕ ПЕСКА ПОД ВЕКА МИ И ОТДЕЛЯЕМОЕ ИЗ ОБОИХ ГЛАЗ, ОБНАРУЖЕНО: ВЕКИ ОБОИХ ГЛАЗ СЛЕГКА ГИПЕРЕМИРОВАНЫ И ОТЕЧНЫ. КОНЬЮКТИВА ВЕК РЕЗКО ГИПЕРЕМИРОВАНА, РАЗРЫХЛЕНА, БАРХАТИСТА, РИСУНОК ЖЕЛЕЗОК, ХРЯЩА НЕ ПРОСМАТРИВАЕТСЯ. НА КОНЬЮКТИВЕ ВЕК
55
СЕРЫЕ, ЛЕГКО СНИМАЕМЫЕ ПЛЕНКИ. НА КОНЬЮКТИВЕ СКЛЕРЫ МНОГОЧИСЛЕННЫЕ КРОВОИЗЛИЯНИЯ. ВАШ ДИАГНОЗ?
1) пневмококковый конъюнктивит
2) острый бактериальный стафилококковый конъюнктивит
...
49. У РЕБЕНКА 5 ЛЕТ ЖАЛОБЫ НА ПОВЫШЕНИЕ ТЕМПЕРАТУРЫ. БОЛЬ В ГОРЛЕ; ПОКРАСНЕНИЕ И ОТДЕЛЯЕМОЕ ИЗ ПРАВОГО ГЛАЗА. ТЕМПЕРАТУРА ТЕЛА 37,8°С. РЕБЕНОК ВЯЛ, АДИНАМИЧЕН. ЗЕВ ГИПЕРЕМИРОВАН. МИНДАЛИНЫ ОТЕЧНЫ, ПОКРЫТЫ ГРЯЗНО-СЕРЫМИ ПЛЕНКАМИ. ОU: ВЕ-КИ ОТЕЧНЫ. КОНЪЮНКТИВА ВЕК РЕЗКО ГИПЕРЕ56
МИРОВАНА, РАЗРЫХЛЕНА И БАРХАТИСТА. НА НЕЙ ИМЕЮТCЯ СЕРЫЕ ПЛЁНКИ, СНИМАЕМЫЕ С ТРУДОМ С ПОСЛЕДУЮЩИМ КРОВОТЕЧЕНИЕМ. ОФТАЛЬМОЛОГИЧЕСКИЙ ДИАГНОЗ?
...
50. У РЕБЕНКА ЖАЛОБЫ НА ПОВЫШЕНИЕ ТЕМПЕРАТУРЫ, ПОКРАСНЕНИЕ И НАЛИЧИЕ ОТДЕЛЯЕМОГО ИЗ ПРАВОГО ГЛАЗА, ТЕМПЕРАТУРА ТЕЛА 38.5°С, ЗЕВ ГИПЕРЕМИРОВАН, НА ЗАДНЕЙ СТЕНКЕ ГЛОТКИ КРУПНЫЕ ФОЛЛИКУЛЫ, КОНЪЮКТИВА ОТЕЧНА ГИПЕРЕМИРОВАНА И ИМЕЕТ СЕРЫЕ ПЛОХО ОТДЕЛЯЕМЫЕ ПЛЕНКИ, С ПОСЛЕДУЮЩИМ КРОВОТЕЧЕНИЕМ, В КОНЪЮКТИВЕ СКЛЕРЫ КРОВОИЗЛИЯНИЯ. ВАШ ДИАГНОЗ?
1) дифтерия
2) дифтерия конъюнктивы
3) острый эпидемический конъюнктивит Коха-Уикса
4) пневмококковый конъюнктивит
5) аденофарингоконъюнктивальная лихорадка (пленчатая форма)
1. КАКОВО ГИСТОЛОГИЧЕСКОЕ СТРОЕНИЕ РОГОВИЦЫ?
1) передний и задний эпителий, собственное вещество (строма)
2) передний и задний эпителий, передняя и задняя пограничные пластин ки, строма
3) передний и задний пигментный эпителий, передняя и задняя пограничные пластинки, строма
20
2. КАКОЕ СВОЙСТВО ПЕРЕДНЕГО ЭПИТЕЛИЯ РОГОВИЦЫ ЯВЛЯЕТСЯ ОСНОВНЫМ?
1) участие в выработке слезной жидкости
2) высокая регенеративная способность
3) механическая защита подлежащих тканей
3. КАКОВА ФУНКЦИЯ СОБСТВЕННОГО ВЕЩЕСТВА (СТРОМЫ) РОГОВИЦЫ?
...
4. КАКИЕ ИЗ ПЕРЕЧИСЛЕННЫХ ФУНКЦИЙ ЯВЛЯЮТСЯ ОСНОВНЫМИ ФУНКЦИЯМИ РОГОВИЦЫ?
...
2) 40,0-42,0 диоптрии
3) 1,5-2,0 диоптрии
4) 28,0-30,0 диоптрий
5) 60,0-62,0 диоптрии
6. КАКОВЫ ПАРАМЕТРЫ ДИАМЕТРА РОГОВИЦЫ В НОРМЕ?
...
7. НАЗОВИТЕ ИСТОЧНИКИ ПИТАНИЯ РОГОВИЦЫ.
...
8. КАКИЕ ПРИЗНАКИ ХАРАКТЕРНЫ ДЛЯ НОРМАЛЬНОЙ РОГОВИЦЫ?
...
9. КАКИЕ СТРУКТУРЫ ОБЕСПЕЧИВАЮТ ИННЕРВАЦИЮ РОГОВИЦЫ?
1) первая ветвь тройничного нерва, симпатические волокна сплетения внутренней сонной артерии
2) первая ветвь тройничного нерв, симпатические волокна сонной артерии, лицевой нерв
3) первая ветвь тройничного нерва, лицевой нерв, парасимпатические волокна глазодвигательного нерва
10. В КАКИХ СЛОЯХ РОГОВИЦЫ НАХОДИТСЯ ПОДАВЛЯЮЩЕЕ БОЛЬШИНСТВО ЧУВСТВИТЕЛЬНЫХ НЕРВНЫХ ОКОНЧА НИЙ?
1) в поверхностных слоях стромы и переднем эпителии
2) в переднем эпителии, поверхностных и глубоких слоях стромы
3) в переднем эпителии, поверхностных и глубоких слоях стромы, заднем эпителии
11. КАКИЕ МЕТОДЫ НАИБОЛЕЕ ИНФОРМАТИВНЫ ДЛЯ ИССЛЕДОВАНИЯ СОСТОЯНИЯ РОГОВИЦЫ?
...
12. КАКИЕ ПРЕПАРАТЫ НЕОБХОДИ МО ИНСТИЛЛИРОВАТЬ В КОНЪЮНКТИВАЛЬНУЮ ПОЛОСТЬ ДЛЯ ОПРЕДЕЛЕНИЯ ЦЕЛОСТНОСТИ ЭПИТЕЛИЯ РОГОВИЦЫ?
1) Sol. Dicaini 0,5%
2) Sol. Collargoli 1%
3) Sol. Sulfacyli-natrii 30%
4) Sol. Fluoresceini 1%
13. КАКИЕ МЕТОДЫ ПРИМЕНЯЮТ ДЛЯ ОРИЕНТИРОВОЧНОЙ ПРОВЕРКИ ЧУВСТВИТЕЛЬНОСТИ РОГОВИЦЫ?
1) метод «воздушной струи» (из резиновой груши или рта)
2) касание тонким жгутиком, свернутым из влажной ваты
3) дотрагиваются до роговицы концом стеклянной палочки или пипетки, полоской бумаги
22
14. КАК НАЗЫВАЕТСЯ ВОСПАЛИТЕЛЬНОЕ ЗАБОЛЕВАНИЕ РОГОВИЦЫ?
1) иритом
2) кератитом
3) конъюнктивитом
4) циклитом
15. КАКОЙ ВИД ИНЪЕКЦИИ ГЛАЗА ХАРАКТЕРЕН ДЛЯ КЕРАТИТОВ?
1) конъюнктивальная инъекция
2) перикорнеальная инъекция
3) смешанная инъекция
4) застойная инъекция
16. ВЫБЕРИТЕ ПРИ ЗНАКИ ПЕРИКОРНЕАЛЬНОЙ ИНЪЕКЦИИ:
1) расширенные сосуды краевой петлистой сети, не видимые из-за матовой эписклеры, просвечивающиеся розово-фиолетовым ореолом по лимбу с убывающей интенсивностью по направлению к сводам
...
17. КАК НАЗЫВАЕТСЯ ВОСПАЛИТЕЛЬНЫЙ ОЧАГ В РОГОВИЦЕ?
1) абсцессом
2) флегмоной
3) инфильтратом
18. КАКОВ ХАРАКТЕР ПОМУТНЕНИЙ ПРИ КЕРАТИТЕ?
...
21. ПРИ БЕЛЬМЕ (ЛЕЙКОМЕ) ПОМУТНЕНИЯ В ЗОНЕ ПРОРАЖЕНИЯ…?
1) серого цвета с сохранением зеркального блеска
2) серого цвета с отсутствием зеркального блеска
3) белого цвета с сохранением зеркального блеска
4) белого цвета с отсутствием зеркального блеска
...
23. КАК НАЗЫВАЕТСЯ СИНДРОМ, С ТИПИЧНЫМИ ДЛЯ КЕРАТИТА ЖАЛО БАМИ В СОЧЕТАНИИ С ПЕРИКОРНЕАЛЬНОЙ ИНФЕКЦИЕЙ?
1) кератитным
2) роговичным
3) перикорнеалыным
24. ЧТО ПРОИСХОДИТ С ИНФИЛЬТРАТОМ В НАЧАЛЕ ОСТРОГО ВОСПАЛИТЕЛЬНОГО ПРОЦЕССА РОГОВИЦЫ?
1) рубцуется
2) метастазирует
3) изъязвляется
24
25. КАКИЕ ВИДЫ КЕРАТИТА ЯВЛЯЮТСЯ ЭКЗОГЕННЫМИ?
1) травматические, гнойные, поверхностные, вызванные не смыканием глазной щели
...
26. КАКИЕ ВИДЫ КЕРАТИТА ЯВЛЯЮТСЯ ЭНДОГЕННЫМИ?
1) травматические, гнойные, поверхностные, вызванные не смыканием глазной щели
2) генерализованая (специфическая инфекция), нейропаралитические, авита минозные
3) склерозирующие, глубокие, нейрогенные, аллергические
4) травматические, инфекционные, вызванные заболеваниями придаточного аппарата глаза
27. КАКОЕ НАЗВАНИЕ ПОЛУЧИЛОВРАСТАНИЕ КРОВЕНОСНЫХ СОСУДОВ В РОГОВИЦУ?
1) инфильтрация
2) лейкома
3) васкуляризация
28. ОТ КАКИХ УСЛОВИЙ ЗАВИСИТ ХАРАКТЕР ВАСКУЛЯРИЗАЦИИ (ГЛУБОКАЯ ИЛИ ПОВЕРХНОСТНАЯ)?
...
29. ДЛЯ КАКОГО КЕРАТИТА ХАРАК ТЕРНО ЗНАЧИТЕЛЬНОЕ ПОНИЖЕНИЕ ЧУВСТВИТЕЛЬНОСТИ РОГОВИЦЫ?
1) бактериального
2) туберкулезного
3) герпетического
4) сифилитического
30. КАКИЕ ВОЗБУДИТЕЛИ, НАИБОЛЕЕ ВЕРОЯТНО, ЯВЛЯЮТСЯ ИНДУКТОРАМИ ГНОЙНОЙ ЯЗВЫ РОГОВИЦЫ?
1) аденовирусы, вирус герпеса, микробактерии
25
2) синегнойная и кишечная палочки
3) диплококк, стрептококк, стафилококк
31. КАК НАЗЫВАЕТСЯ СКОПЛЕНИЕ ГНОЯ НА ДНЕ ПЕРЕДНЕЙ КАМЕРЫ?
1) гифемой
2) гипопионом
3) лейкомой
32. КАКОВЫ ОСНОВНЫЕ КЛИНИЧЕСКИЕ СИМПТОМЫ ПОЛЗУЧЕЙ ЯЗВЫ РОГОВИЦЫ:
...
3) наличие прогрессирующей зоны язвы (активный край), ранний иридоциклит с гипопионом
33. КАКОВЫ ВОЗМОЖНЫЕ ОСЛОЖНЕНИЯ ГНОЙНОЙ ЯЗВЫ РОГОВИЦЫ?
...
34. ПРОВЕДЕНИЕ КАКИХ ЛАБОРАТОРНЫХ ИССЛЕДОВАНИЙ НЕОБХОДИМО ПРИ ГНОЙНЫХ КЕРАТИТАХ?
1) иммунологических
2) биохимических
3) микроскопических и бактериологических
4) флюоресцентных методов исследования
35. КАКОВЫ ПРИНЦИПЫ КОНСЕРВАТИВНОЙ ТЕРАПИИ ГНОЙНЫХ КЕРАТИТОВ?
...
38. КАКОВЫ КЛИНИЧЕСКИЕ ОСОБЕННОСТИ ГЕРПЕТИЧЕСКИХ КЕРАТИТОВ?
...
39. КАКИЕ ИНСТИЛЛЯЦИИ НАЗНАЧАЮТ ПРИ ЛЕЧЕНИИ ГЕРПЕТИЧЕСКИХ КЕРАТИТОВ?
1) Sol. Sulfacyli-natrii 30%
2) Sol. Gentamycini 0,3%, Soi. Penicillini 1%
3) Sol. Iinterferoni leicocytaris, Sol.Dezoxyribonucleazae, Sol. IDU
4) Sol.Dexametazoni 0,1%, Sol.Hydrocortizoni 0,5%
40. КАКИЕ ГЛАЗНЫЕ МАЗИ НАЗНАЧАЮТСЯ ПРИ ГЕРПЕТИЧЕСКИХ КЕРАТИТАХ?
1) Ung. Solcoserili (Actovegini) 20%
2) Ung. Hydrocortizoni 0,5%, Ung. Prednizotoni 1%
3) Ung. Laevomycetini 5%, Ung. Gentamycini 1%
4) Ung. Bonaphtoni 0,05%, Ung. Tebrofeni 0,1%, Ung. Florenali 0,1%, и Ung.Zoviraxi 3%
27
41. В КАКОМ ВОЗРАСТЕ ЧАЩЕ ВОЗНИКАЮТ ТУБЕРКУЛЕЗНО-АЛЛЕРГИЧЕСКИЕ КЕРАТОКОНЪЮНКТИВИТЫ?
1) детском
2) пожилом
3) зрелом
42. КАКОЕ НАЗВАНИЕ ПОЛУЧИЛИ ПОЛУПРОЗРАЧНЫЕ, КРУГЛЫЕ, СЕРОГО ЦВЕТА «УЗЕЛКИ», ПОЯВЛЯЮЩИЕСЯ ВБЛИЗИ ЛИМБА ПРИ ТУБЕРКУЛЕЗНО-АЛЛЕРГИЧЕСКОМ КЕРАТИТЕ?
1) инфильтрат
2) фликтена
3) язва
4) пустула
43. КАКОВ ИСХОД ТУБЕРКУЛЕЗНО-АЛЛЕРГИЧЕСКОГО КЕРАТИТА?
1) стойкий инфильтрат
2) стойкое бельмо
3) значительное истончение роговицы
44. КАКОВ ПУТЬ ПРОНИКНОВЕНИЯ В РОГОВИЦУ ИНФЕКЦИИ ПРИ ТУБЕРКУЛЕЗЕ?
1) из внешней среды
...
1) односторонними
2) двусторонними
46. КАКИЕ СТРУКТУРЫ РОГОВИЦЫ ПОРАЖАЕТ СПЕЦИФИЧЕСКИЙ ТУБЕРКУЛЕЗНЫЙ ПРОЦЕСС?
1) поверхностные слои роговицы
2) глубокие слои роговицы
47. КАКОВА ВАСКУЛЯРИЗАЦИЯ ПРИ ТУБЕРКУЛЕЗНОМ КЕРАТИТЕ?
1) не характерна
2) глубокая
3) поверхностная, нежная
48. КАКОВ ПРОГНОЗ ТУБЕРКУЛЕЗНОГО КЕРАТИТА?
4) благоприятный
5) неблагоприятный
57
49. ЧТО ПОКАЗАНО В ОТДАЛЕННОМ РЕМИССИОННОМ ПЕРИОДЕ РЕЦИДИВИРУЮЩЕГО ТУ БЕРКУЛЕЗНОГО КЕРАТИТА?
1) ревакцинация
2) курсовая противовоспалительная терапия
3) кератопластика
50. КТО ПРОВОДИТ ЛЕЧЕНИЕ ТУБЕРКУЛЕЗНЫХ КЕРАТИТОВ?
1) окулист поликлиники
2) семейный врач
3) офтальмолог хирургической клиники
4) фтизиоофтальмолог
51. В КАКОМ ВОЗРАСТЕ ОБЫЧНО ВОЗНИКАЕТ ПАРЕНХИМАТОЗНЫЙ (ИНТЕРСТИЦИАЛЬНЫЙ СИФИЛИТИЧЕСКИЙ КЕРАТИТ?
1) детском
2) пожилом
3) зрелом
...
3) вторичного
4) врожденного
53. КАКИЕ СТАДИИ ВЫДЕЛЯЮТ В ТЕЧЕНИИ СИФИЛИТИЧЕСКОГО ПАРЕНХИМАТОЗНОГО КЕРАТИТА?
...
54. ХАРАКТЕРНЫЕ КЛИНИЧЕСКИЕ ОСОБЕННОСТИ СИФИЛИТИЧЕСКОГО ПАРЕНХИМАТОЗНОГО КЕРАТИТА?
...
58
55. ЧТО ОТМЕЧАЕТСЯ ПРИ СИФИЛИТИЧЕСКОМ ПАРЕНХИМАТОЗНОМ КЕРАТИТЕ?
1) лишь поверхностная васкуляризация
2) глубокая васкуляризация роговицы
3) врастания сосудов не наблюдается
56. КАК ИЗМЕНЯЕТСЯ СОСТОЯНИЕ РОГОВИЦЫ ПО МЕРЕ НА РАСТАНИЯ ИНФИЛЬТРАЦИИ ПРИ СИФИЛИТИЧЕСКОМ ПАРЕНХИМАТОЗНОМ КЕРАТИТЕ?
1) изъязвляется
2) истончается
3) утолщается
57. КАКОВ ИСХОД ПАРЕНХИМАТОЗНОГО КЕРАТИТА ПРИ АДЕКВАТНОМ ЛЕЧЕНИИ?
1) благоприятный
2) сомнительный
3) неблагоприятный
58. КАК НАЗЫВАЕТСЯ ОГРАНИЧЕННОЕ ПОМУТНЕНИЕ РОГОВИЦЫ ПЕРВОЙ СТЕПЕНИ, ЕДВА ВИДИМОЕ ПРИ БОКОВОМ ОСВЕЩЕЩЕНИИ, ОБЫЧНО НЕ ДАЮЩЕЕ СНИЖЕНИЯ ОСТРОТЫ ЗРЕНИЯ?
1) инфильтрат
2) облачко (nubecula)
3) пятно (macula)
4) бельмо (leucoma)
59. НАЗОВИТЕ СТОЙКОЕ ОГРАНИЧЕННОЕ ПОМУТНЕНИЕ ВТОРОЙ СТЕПЕНИ, ВИДИМОЕ И НЕВООРУЖЕННЫМ ГЛАЗОМ.
1) облако
2) бельмо (leucoma)
3) пятно (macula)
60. КАК НАЗЫВАЕТСЯ СТОЙКОЕ, ЧАСТО СОСУДИСТОЕ ПОМУТНЕНИЕ (Т З-4 СТЕПЕНИ), СВЕТЛО СЕРОГО ИЛИ БЕЛОГО ЦВЕТА, ЗАНИМАЮЩЕЕ БОЛЬШУЮ ЧАСТЬ РОГО ВИЦЫ, СОПРОВОЖДАЮЩЕЕСЯ ЗНАЧИТЕЛЬНЫМ СНИЖЕНИЕМ ПРЕД МЕТНОГО ЗРЕНИЯ?
1) васкуляризацией
59
2) бельмом (leucoma)
3) рубцом
4) пятном (macula)
61. В ЧЁМ ЗАКЛЮЧАЕТСЯ КОНСЕРВАТИВНОЕ ЛЕЧЕНИЕ ФОРМИРУЮЩИХСЯ ПОМУТНЕНИЙ РОГО ВИЦЫ?
1) ферментов
2) витаминотерапии
3) тканевых биостимуляторов
4) иммуномодуляторов
62. КАКОВ СИМПТОМОКОМПЛЕКС ПРИ ИРИДОЦИКЛИТЕ?
...
63. КАКИЕ ЖАЛОБЫ ТИПИЧНЫ ДЛЯ ОСТРОГО ИРИДОЦИКЛИТА?
1) светобоязнь, ломящая боль при взгляде на источник света чувство распирания в глазу туман перед взором
2) слезотечение, чувство жжения и «замусоренности» за веками, «слипание» век по утрам, легкая пелена перед взором
3) светобоязнь, слезотечение, блефароспазм, чувство инородного тела за верхним веком, снижение остроты зрения
4) ноющие, пульсирующие боли в глазу, «пелена» перед глазом, радужные круги
5) при взгляде на источник света
64. ИЗ СКОЛЬКИ ЧАСТЕЙ СОСТОИТ СОСУДИСТАЯ ОБОЛОЧКА?
1) 2
2) 3
3) 4
4) 5
60
65. КАКИЕ АНАТОМИЧЕСКИЕ СТРУКТУРЫ РАСПОЛОЖЕНЫ В РАДУЖНОЙ ОБОЛОЧКЕ?
...
66. В СОСТАВ КАКИХ НЕРВОВ ВХОДЯТ ВОЛОКНА, ИННЕРВИРУЮЩИЕ СФИНКТЕР ЗРАЧКА?
1) n. trochlearis
2) n. oculomotorius
3) n. facialis
4) n. trigeminus
67. КАКИМ НЕРВОМ ОБЕСПЕЧИВАЕТСЯ ИННЕРВАЦИЯ СФИНКТЕРА ЗРАЧКА?
1) парасимпатическим нервом
2) симпатическим нервом
3) соматическим нервом
68. КАКИМ НЕРВОМ ОБЕСПЕЧИВАЕТСЯ ИННЕРВАЦИЯ ДИЛАТАТОРА ЗРАЧКА?
1) парасимпатическим нервом
2) симпатическим нервом
3) соматическим нервом
69. КАКОЙ НЕРВ ОБЕСПЕЧИВАЕТ ЧУВСТВИТЕЛЬНУЮ ИННЕРВАЦИЮ РАДУЖНОЙ ОБОЛОЧКИ?
1) глазодвигательным
2) лицевым
3) отводящим
4) симпатическим
...
61
70. КАКОЙ НЕРВ ОБЕСПЕЧИВАЕТ ЧУВСТВИТЕЛЬНУЮ ИННЕРВАЦИЮ ЦИЛИАРНОГО ТЕЛА?
1) глазодвигательным
2) лицевым
3) отводящим
4) симпатическим
...
8) тройничным (вторая ветвь)
9) чувствительных нервов нет
71. КАКОЙ НЕРВ ОБЕСПЕЧИВАЕТ ЧУВСТВИТЕЛЬНУЮ ИННЕРВАЦИЮ ХОРИОИДЕИ?
1) симпатическим
2) парасимпатическим
3) тройничным (первая ветвь)
4) тройничным (вторая ветвь)
5) чувствительных нервов нет
72. ЗА СЧЕТ КАКИХ СОСУДОВ ОСУЩЕСТВЛЯЕТСЯ ТРОФИКА РАДУЖКИ И ЦИЛИАРНОГО ТЕЛА?
...
73. КАКИЕ ДВЕ ФУНКЦИИ ВЫПОЛНЯЕТ ЦИЛИАРНОЕ ТЕЛО?
...
74. КАК НАЗЫВАЕТСЯ ИНЪЕКЦИЯ, ЦВЕТ КОТОРОЙ ИМЕЕТ СИНЮШНЫЙ ОТТЕНОК, НАИБОЛЬШУЮ ИНТЕНСИВНОСТЬ ВОКРУГ РОГОВИЦЫ И ОСЛАБЛЯЕТСЯ К ПЕРИФЕ62
РИИ, ИМЕЕТ ДИФФУЗНОЕ ПОКРАСНЕНИЕ И ОТДЕЛЬНЫЕ СОСУДЫ НЕ ВИДНЫ?
1) конъюнктивальной
2) смешанной
3) перикорнеальной
...
6) все перечисленные
77. УКАЖИТЕ ПРИЗНАК НЕ ХАРАКТЕРНЫЙ ДЛЯ ЦЕНТРАЛЬНОГО ХОРИОРЕТИНИТА
1) боль в глазу
2) фотопсии
3) снижение зрения
4) метаморфопсии
...
3) диакарб внутрь
4) глицерол внутрь
93. КАКИЕ ИЗ ПЕРЕЧИСЛЕННЫХ МЕТОДОВ ИСПОЛЬЗУЮТСЯ ДЛЯ ДИАГНОСТИКИ ОПУХОЛЕЙ СОСУДИСТОГО ТРАКТА
1) биомикроскопия
...
1. КАКОВЫ СИМПТОМЫ ЗРЕЛОЙ ВОЗРАСТНОЙ КАТАРАКТЫ?
1) зрачок серого цвета, рефлекса с глазного дна нет, ВГД в норме
...
5) зрачок серого цвета, при исследовании в проходящем свете видны темные полосы в виде «спиц в колесе», ВГД в норме
2. КАКОВЫ ПРИЗНАКИ НАЧИНАЮЩЕЙСЯ ВОЗРАСТНОЙ КАТАРАКТЫ?
1) зрачок серого цвета, рефлекса с глазного дна нет, ВГД в норме
2) перикорнеальная инъекция, на задней поверхности роговицы преципитаты, зрачок, узкий, ВГД в норме
3) глаз спокойный, зрачок черный, на глазном дне атрофия и экскавация зритель ного нерва, ВГД повышено
4) застойная инъекция глазного яблока, передняя камера мелкая, зрачок широ кий, ВГД высокое
5) зрачок серого цвета, при исследовании в проходящем свете видны темные полосы в виде «спиц в колесе», ВГД в норме
3. КАК ИМЕНУЕТСЯ ПОМУТНЕНИЕ ХРУСТАЛИКА?
1) катаракта
2) афакия
3) бельмо
4) глаукома
...
5) бурая
6) зонулярная
8. САМЫМИ ЧАСТЫМИ ПРИЧИНАМИ ПОЯВЛЕНИЯ ВРОЖ-
ДЕННЫХ КАТАРАКТ ЯВЛЯЮТСЯ?
...
4) все перечисленное
9. В КАКОМ ВОЗРАСТЕ ФОРМИРУЕТСЯ ЯДРО ХРУСТАЛИКА?
1) 10 лет
2) 15 лет
3) 25 лет
4) 40 лет
...
4) травматическая
5) лучевая
11. У БОЛЬНОГО 56 ЛЕТ В ОБОИХ ГЛАЗАХ ОБНАРУЖЕНА ЗОНУЛЯРНАЯ КАТАРАКТА. К КАКОМУ ВИДУ КАТАРАКТ ВЫ ЕЕ ОТНЕСЕТЕ?
1) врожденная
2) приобретенная
3) старческая
4) осложненная
...
6) все перечисленное
1. ПОЖИЛОЙ ГИПЕРТОНИК ВНЕЗАПНО ПОТЕРЯЛ ЗРЕНИЕ ПРАВОГО ГЛАЗА ДО СЧЕТА ПАЛЬЦЕВ У ЛИЦА. ДО ЭТОГО ЗАМЕЧАЛ КРАТКОВРЕМЕННОЕ СНИЖЕНИЕ ЗРЕНИЯ ЭТОГО ГЛАЗА, НО ЗРЕНИЕ ВОССТАНАВЛИВАЛОСЬ. НА ГЛАЗНОМ ДНЕ ДИСК ЗРИТЕЛЬНОГО НЕРВА С РАЗМЫТЫМИ ГРАНИЦАМИ, ОТЕК СЕТЧАТКИ. В МАКУЛЯРНОЙ ОБЛАСТИ ВИДНА «ВИШНЕВАЯ КОСТОЧКА». АРТЕРИИ УЗКИЕ. КАКОЕ ЭТО ЗАБОЛЕВАНИЕ?
...
5) макулодистрофия
2. ПОЖИЛОЙ ГИПЕРТОНИК ВНЕЗАПНО ПОТЕРЯЛ ЗРЕНИЕ ПРАВОГО ГЛАЗА ДО СЧЕТА ПАЛЬЦЕВ У ЛИЦА. ДО ЭТОГО ЗАМЕЧАЛ КРАТКОВРЕМЕННОЕ СНИЖЕНИЕ ЗРЕНИЯ ЭТОГО ГЛАЗА, НО ЗРЕНИЕ ВОССТАНАВЛИВАЛОСЬ. НА ГЛАЗНОМ ДНЕ ДИСК ЗРИТЕЛЬНОГО НЕРВА С РАЗМЫТЫМИ ГРАНИЦАМИ, ОТЕК СЕТЧАТКИ. В МАКУЛЯРНОЙ ОБЛАСТИ ВИДНА
32
«ВИШНЕВАЯ КОСТОЧКА». АРТЕРИИ УЗКИЕ. НЕОТЛОЖНАЯ ПОМОЩЬ:
1) инстилляция мидриатиков и введение гепарина
2) инстилляция мидриатиков
3) введение гепарина и сосудорасширяющих средств
3. КАКИЕ ХАРАКТЕРНЫЕ СИМПТОМЫ НА ГЛАЗНОМ ДНЕ ПРИ ГИПЕРТОНИЧЕСКОЙ БОЛЕЗНИ?
...
5. КАКИЕ СИМПТОМЫ ХАРАКТЕРНЫ ПРИ ТИРЕОТОКСИКОЗЕ?
...
6. КАКИЕ СИМПТОМЫ ХАРАКТЕРНЫ ПРИ САХАРНОМ ДИАБЕТЕ?
1) глаз белый, центральная скотома, побледнение височной половины диска зрительного нерва, ВГД в норме
2) глаз белый, зрение не нарушено, на глазном дне микроаневризмы, симптомы Салюса-Гунна и Гвиста
3) глаз белый, понижение остроты зрения, микроаневризмы, кровоизлияния и белые очаги на глазном дне, ВГД в норме
4) глаз белый, экзофтальм, отставание верхнего века при взгляде вниз, острота зрения не нарушена, ВГД в норме
33
7. КАКИЕ ЗАБОЛЕВАНИЯ МОГУТ СОПРОВОЖДАТЬСЯ НЕВРИТОМ ЗРИТЕЛЬНОГО НЕРВА?
1) заболевании крови
2) полиневрите
3) гнойном воспалении пазух носа
4) параличе лицевого нерва
5) контузии головного мозга
8. ЖЕНЩИНА 25 ЛЕТ ЗАМЕТИЛА ВНЕЗАПНОЕ ПОНИЖЕНИЕ ЗРЕНИЯ ПРАВО ГО ГЛАЗА С ТЕМНЫМ ПЯТНОМ В ЦЕНТРЕ ПОЛЯ ЗРЕНИЯ. ПРАВЫЙ ГЛАЗ БЕЛЫЙ. НЕ БОЛИТ, НО ДВИЖЕНИЕ БОЛЕЗНЕННОЕ. НА ГЛАЗНОМ ДНЕ ЛЕГКОЕ ПО-БЛЕДНЕНИЕ ВИСОЧНОЙ ПОЛОВИНЫ ДИСКА ЗРИТЕЛЬНОГО НЕРВА. КАКОЕ ЗАБОЛЕВАНИЕ У ЭТОЙ ЖЕНЩИНЫ?
...
4) биназальная гемианопсия
5) гомонимная гемианопсия
17. СИМПТОМЫ, ХАРАКТЕРНЫЕ ПРИ РАССЕЯННОМ СКЛЕРОЗЕ
1) глаз белый, центральная скотома, побледнение височной половины диска зрительного нерва, ВГД в норме
2) глаз белый, понижение остроты зрения, микроаневризмы, кровоизлияния и бе-лые очаги на глазном дне, ВГД в норме
...
1. КАКИЕ КАПЛИ ИСПОЛЬЗУЮТ ДЛЯ СНИЖЕНИЯ ВНУТРИГЛАЗНОГО ДАВЛЕНИЯ?
1) 1% раствор атропина, 0,5% раствор тимолола
2) 0,5% раствор тимолола, 1% раствор пилокарпина
2. ВСЛЕДСТВИЕ ЧЕГО АТРОПИН ПОВЫШАЕТ ВНУТРИГЛАЗНОЕ ДАВЛЕНИЕ?
1) расширения артериол, смещения радужки к фильтрационной зоне
2) сужения артериол, снижения оттока ВГЖ в склеральный синус
34
3. В РЕЗУЛЬТАТЕ ЧЕГО МИДРИАТИКИ ПОВЫШАЮТ ВГД ПРИ ЗАКРЫТОУГОЛЬНОЙ ГЛАУКОМЕ?
1) повышения продукции внутриглазной жидкости
2) зрачкового блока
3) закрытия радужно-роговичного угла радужки
4) ослабления натяжения трабекул
4. КАКИЕ ПРЕПАРАТЫ, ПРИМЕНЯЮТСЯ В ЛЕЧЕНИИ ОТКРЫТОУГОЛЬНОЙ ГЛАУКО МЫ?
1) папаверин, гоматропин
2) пилокарпин, тимолол
3) папаверин, тимолол
4) гоматропин, атропин
5. КАКИЕ ПРЕПАРАТЫ, ПРОТИВОПОКАЗАННЫ ПРИ ГЛАУКОМЕ?
1) папаверин, никошпан
2) папаверин, тимолол
3) пилокарпин, тимолол
4) гоматропин, атропин
6. ЧЕМ ПРОДУЦИРУЕТСЯ ВНУТРИГЛАЗНАЯ ЖИДКОСТЬ?
1) хориоидеей
2) стекловидным телом
3) цилиарным телом
4) радужкой
7. ДЛЯ КАКОГО ЗАБОЛЕВАНИЯ ХАРАКТЕРНО ПОЯВЛЕНИЕ РАДУЖНЫХ КРУГОВ ВОКРУГ ИСТОЧНИКА СВЕТА ПРИ ВЗГЛЯДЕ НА НЕГО?
1) отеке сетчатки
2) иридоциклите
3) закрытоугольной глаукоме
4) гемофтальме
8. КАК ВЫГЛЯДИТ ЗРАЧОК ПРИ ОСТРОМ ПРИСТУПЕ ГЛАУКОМЫ?
1) широкий и реагирует на свет
2) узкий и реагирует на свет
3) широкий и не реагирует на свет
4) узкий и не реагирует на свет
35
9. КАКОВ ДИАПАЗОН НОРМАЛЬНОГО УРОВНЯ ТОНОМЕТРИЧЕСКОГО ВНУТРИГЛАЗНОГО ДАВ ЛЕНИЯ?
1) 14-22 мм рт. ст.
2) 20-22 мм рт. ст.
3) 16-20 мм рт. ст.
4) 32-36 мм рт. ст.
5) 16-26 мм рт. ст.
10. НАЗОВИТЕ ОБЪЕКТИВНЫЕ ПРИЗНАКИ, ХАРАКТЕРНЫЕ ДЛЯ ОТКРЫТОУГОЛЬНОЙ ГЛАУКОМЫ.
...
11. КАКИЕ ОСОБЕННОСТИ ХАРАКТЕРНЫ ДЛЯ КЛИНИЧЕСКОГО ТЕЧЕНИЯ ОТКРЫТОУГОЛЬНОЙ ГЛАУКОМЫ?
...
12. КАКИЕ ОСОБЕННОСТИ ХАРАКТЕРНЫ ДЛЯ КЛИНИЧЕСКОГО ТЕЧЕНИЯ ЗАКРЫТОУГОЛЬНОЙ ГЛАУКОМЫ?
1) бессимптомное течение или чувство полноты в глазу, кажущееся увлажнение глаза
2) затуманивание зрения, появление радужных кругов при взгляде на источник света, периодические боли в глазу и соответствующей половине головы
3) сильные головные боли, тошнота, рвота, стреляющие боли в область глаза
13. КАКАЯ ОПЕРАЦИЯ ПРОИЗВОДИТСЯ ПРИ ОТКРЫТОУГОЛЬНОЙ ГЛАУКОМЕ?
1) фистулизирующая (трабекулоэктомия)
2) периферическая иридэктомия
3) кератотомия
36
14. КАКИЕ ГЛАВНЫЕ ЗВЕНЬЯ В ПАТОГЕНЕЗЕ ОТКРЫТОУГОЛЬНОЙ ГЛАУКОМЫ?
...
15. КАКИЕ ГЛАВНЫЕ ЗВЕНЬЯ В ПАТОГЕНЕЗЕ ЗАКРЫТОУГОЛЬНОЙ ГЛАУКОМЫ?
1) блокада угла передней камеры корнем радужки
2) дистрофические изменения дренажной системы глаза
3) неполное рассасывание мезодермальной эмбриональной ткани в углу перед ней камеры
...
2) дистрофические изменения дренажной системы глаза
3) неполное рассасывание мезодермальной эмбриональной ткани в углу перед ней камеры
17. ЧТО ПРОИСХОДИТ В ГИДРОДИНАМИЧЕСКОЙ СИСТЕМЕ ГЛАЗА ПРИ ОДНОВРЕМЕННОМ ПРИМЕНЕНИИ SOL. PILOCARPIN1 1% И SOL. TIMOLOLI 0,5%?
...
18. НАЗОВИТЕ ДОМИНИРУЮЩИЙ ПРИЗНАК ГЛАУКОМЫ.
1) повышение внутриглазного давления
2) помутнение хрусталика
3) поражение макулярной области
19. КАКОЕ ИЗМЕНЕНИЕ ПЕРИФЕРИЧЕСКИХ ГРАНИЦ ПОЛЯ ЗРЕНИЯ ЯВЛЯЕТСЯ ХАРАКТЕРНЫМ ПРИ ГЛАУКОМЕ?
1) сужение внутренней половины
2) сужение наружной половины
3) сужение верхней половины
20. ХАРАКТЕРНЫМ ИЗМЕНЕНИЕМ ЗРИТЕЛЬНОГО НЕРВА ПРИ ГЛАУКОМЕ ЯВЛЯЕТСЯ
1) атрофия
...
1) зрачок серого цвета, рефлекса с глазного дна нет, ВГД в норме, перикорнеальная инъекция, на задней плоскости роговицы преципитаты
73
...
2) перикорнеальная инъекция, на задней плоскости роговицы преципитаты, зрачок узкий, ВГД в норме
3) глаз спокойный, зрачок черный, на глазном дне атрофия и экскавация зрительного нерва, ВГД повышено
4) застойная инъекция глазного яблока, передняя камера мелкая, зрачок широ кий, ВГД высокое
5) зрачок серого цвета, при исследовании в проходящем свете видны темные полосы в виде «спиц в колесе», ВГД в норме
29. ЖАЛОБЫ ПРИ ОСТРОМ ПРИСТУПЕ ГЛАУКОМЫ
1) светобоязнь, ломящая боль при взгляде на источник света, чувство распирания в глазу, туман перед взором
2) слезотечение, чувство жжения и «засорённости» за веками, «слипание» век по утрам, легкая пелена перед взором
3) веком, снижение остроты зрения
4) ноющие, пульсирующие боли в глазу, «пелена» перед глазом, радужные круги при взгляде на источник света
30. ВЫРАБОТКА ВНУТРИГЛАЗНОЙ ЖИДКОСТИ ПРОИСХОДИТ В
1) цилиарном теле
2) хориоидее
...
3) 10,0
4) 15,0
36. С ПОМОЩЬЮ КАКИХ ДВУХ МЕТОДОВ ВЫЯВЛЯЕТСЯ ДЕФЕКТЫ ПОЛЯ ЗРЕ-НИЯ ПРИ ГЛАУКОМЕ
1) аномалоскопию и биомикро-скопию
2) биомикроскопию и визомет-рию
...
5) гониоскопией
6) биомикроскопией
1. КАКОЙ ПРЕПЕРАТ НУЖНО ЗАКАПАТЬ В ГЛАЗ ДЛЯ ДИАГНОСТИКИ ЭРОЗИИ РОГОВИЦЫ?
1) Sol.Sulfacili-natrii 30%
2) Sol.Fiuoresceinr 1%
3) Sol. Furacilini 0,02 %
4) Sol. Atropini sulfatis 1%
2. К КАКОМУ ОСЛОЖНЕНИЮ СО СТОРОНЫ ЗДОРОВОГО ГЛАЗА МОЖЕТ ПРИВЕСТИ ПРОБОДНОЕ РАНЕНИЕ ГЛАЗНОГО ЯБЛОКА С ПОВРЕЖДЕНИЕМ УВЕАЛЬНОЙ ТКАНИ?
1) травматической катаракты
2) симпатической офтальмии
3) травматической отслойки сетчатки
3. КАКИЕ ВЫДЕЛЯЮТ ФОРМЫ СИМПАТИЧЕСКОЙ ОФТАЛЬМИИ?
...
4. КАКИЕ ПОВРЕЖДЕНИЯ РАДУЖКИ МОГУТ БЫТЬ ПРИ ТУПОЙ ТРАВМЕ ГЛАЗА?
...
5. НАРУЖНАЯ ОФТАЛЬМОПЛЕГИЯ СВЯЗАНА С ПОРАЖЕНИЕМ
1) n. abducens, n. facialis, n. opticus
2) n. opfcus, n. trigeminus., n. facialis
3) n. аbducens, n. trochtearis, n. ocutomotorius
4) n. ocuiomotorius, n. facialis, n. opticus
6. ПЕРВАЯ ВРАЧЕБНАЯ ПОМОЩЬ ПРИ ТРАВМЕ ВКЛЮЧАЕТ НАЗНАЧЕНИЕ
1) холода на область глаза
2) диуретиков
3) гемостатический средств
4) анальгетиков
5) гипотензивных препаратов
7. ОТРАВЛЕНИЕ МЕТИЛОВЫМ СПИРТОМ ПРИВОДИТ К
1) развитию дистрофии роговицы
2) развитию катаракты
3) атрофии зрительного нерва
4) помутнению стекловидного тела
5) рецидивирующему увеиту
8. ПРИ РАНАХ ВЕК РЕГЕНЕРАЦИЯ ТКАНЕЙ
1) высокая
2) низкая
...
9. ПРИ ТУПОЙ ТРАВМЕ ГЛАЗА БЫВАЮТ СЛЕДУЮЩИЕ ПОВРЕЖДЕНИЯ РАДУЖКИ
1) мидриаз, иридодиализ, аниридия, разрыв стромы
2) мидриаз, иридодиализ, аниридия, разрыв зрачкового края
3) мидриаз, иридодиализ, аниридия, разрыв стромы или пигментного слоя
39
10. СУБАТРОФИЯ ГЛАЗНОГО ЯБЛОКА ПОСЛЕ ТРАВМЫ МОЖЕТ БЫТЬ ОБУСЛОВЛЕНА
...
11. НАЛИЧИЕ КРОВИ В ПЕРЕДНЕЙ КАМЕРЕ НАЗЫВАЕТСЯ
1) гемофтальм
2) гемианопсия
3) гифема
76
12. НАЛИЧИЕ КРОВИ В СТЕКЛОВИДНОМ ТЕЛЕ НАЗЫВАЕТСЯ
1) гемофтальм
2) гемианопсия
3) гифема
13. ПРИЧИНОЙ ГИФЕМЫ ПРИ ТУПОЙ ТРАВМЕ ГЛАЗА МОЖЕТ БЫТЬ НАРУШЕ НИЕ ЦЕЛОСТНОСТИ
1) роговицы и радужки
2) радужки и цилиарного тела
3) цилиарного тела и роговицы
14. ПРИ КОНТУЗИИ СЕТЧАТКИ НАБЛЮДАЮТСЯ СЛЕДУЮЩИЕ ИЗМЕНЕНИЯ
1) некроз, кровоизлияние, разрыв, отслойка
2) гипертензия, кровоизлияние, разрыв, отслойка
3) отек, кровоизлияние, разрыв, отслойка
15. ПРИ ТУПОЙ ТРАВМЕ НАБЛЮДАЮТСЯ СЛЕДУЮЩИЕ ПОВРЕЖДЕНИЯ ЗРИТЕЛЬНОГО НЕРВА
...
16. ИНОРОДНОЕ ТЕЛО, РАСПОЛОЖЕННОЕ В СЛОЯХ РОГОВИЦЫ, ПОДЛЕЖИТ УДАЛЕНИЮ В СЛЕДУЮЩИХ СЛУЧАЯХ:
...
5) верно все перечисленное
17. ПОКАЗАНИЕМ К ЭНУКЛЕАЦИИ ЯВЛЯЕТСЯ
1) абсолютно болящий слепой глаз
2) меланома хориоидеи, ретинобластома
3) симпатическая офтальмия
4) слепой глаз, размозженный травмой
5) верно все перечисленное
77
18. ПРИ ЛЕЧЕНИИ ОЖОГОВ ВЕК ИСПОЛЬЗУЮТСЯ
1) антигистаминные препараты, антибиотики
2) антибиотики
3) кортикостероиды
4) диуретик
5) гипотензивные
6) криоферментоаппликации
19. КАКОЙ ПРИЗНАК, НЕ ЯВЛЯЕТСЯ ДОСТОВЕРНЫМ ПРИ ПРОНИКАЮЩЕМ РАНЕНИИ ГЛАЗНОГО ЯБЛОКА:
1) наличие раневого канала
2) выпадение оболочек глазного яблока
3) гипотония
4) наличие инородного тела
5) изменение глубины передней камеры
20. ОСЛОЖНЕНИЯМИ ПРОНИКАЮЩИХ РАНЕНИЙ ГЛАЗА ЯВЛЯЮТСЯ:
1) симпатическая офтальмия
2) эндофтальмит
3) вторичная глаукома
4) панофтальмит
5) иридоциклит
21. ПРИ МЕТАЛЛОЗАХ ИНОРОДНЫЕ ТЕЛА НУЖНО УДАЛЯТЬ ИЗ-ЗА:
1) изменения цвета радужки
2) развития катаракты
3) деструкции стекловидного тела
4) нейроретинопатии
5) развития язвы роговицы`.replace(/\n\d+\n/g, '\n')
let questionsArr = questions.split(/\n\d+\. /g).map(v => v.split(/\n\d+\) /g))
let questionsFinal = questionsArr.map((v, i) => {
  return {
    id: `ophtalmo_${i}`,
    arr: v
  }
...
for (let i = 0; i < answerArr.length; i++) {
  answerObj[`ophtalmo_${i}`] = {
    type: answerArr[i].length === 1? 'single': 'many',
    answer: answerArr[i].map(v => v - 1)
  }
}
